...
public class CauldronTweaker {
    ...
    public static void remove(IItemStack output, boolean stoked) {
        ...
        List<BulkRecipe> recipes = MTHelper.copyBulkRecipeList(stoked ? CraftingManagerCauldronStoked.getInstance() : CraftingManagerCauldron.getInstance());
    ...
    private static class Add extends AddBulkAction {
        ...
        public String getHandlerName() {
            return this.stoked ? "Stoked Cauldron" : "Cauldron";
        }
    }
